...
class UsersRoute implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.post(`${this.path}`, isAdminMiddleware, validationMiddleware(UpdateUserAdminDto, "body"), this.userController.updateUserProfile);
    this.router.post(`${this.path}/me`, validationMiddleware(UpdateUserMyDto, "body"), this.userController.updateMyProfile);
    ...
    this.router.get(`${this.path}/:id`, this.userController.getUserProfile);
  }
}
