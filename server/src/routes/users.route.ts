...
class UsersRoute implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.patch(`${this.path}`, isEditorMiddleware, validationMiddleware(UpdateUserAdminDto, "body"), this.userController.updateUserProfile);
    ...
    this.router.get(`${this.path}/:id`, isEditorMiddleware, this.userController.getUserProfile);
  }
}
