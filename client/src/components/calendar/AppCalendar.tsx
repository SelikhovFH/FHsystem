...
export const AppCalendar: AppCalendarType = ({onSelect, renderDateCell, renderEvent, events = [], daysOff = []}) => {
    ...
    return (
        <Calendar onSelect={onSelect} mode={'month'} dateFullCellRender={dateFullCellRender}/>
    )
}
